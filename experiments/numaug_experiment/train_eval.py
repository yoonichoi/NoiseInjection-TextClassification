...
if __name__ == "__main__":
	...
	basepath = f'experiments/numaug_experiment/outputs/{nowstr}'   # (A4)
	...
	for i, dataset_folder in enumerate(dataset_folders):
		...
		for numaug in num_augs:
			...
			num_accs[dataset][numaug] = num_acc
			...
			alpha_accs[dataset][numaug] = alpha_acc
			...
			hybrid_accs[dataset][numaug] = hybrid_acc
			...
			eda_accs[dataset][numaug] = eda_acc
	...
	print(orig_acc)
	print(eda_accs, aeda_accs, num_accs, alpha_accs, hybrid_accs)
