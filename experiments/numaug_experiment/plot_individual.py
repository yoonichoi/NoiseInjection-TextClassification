...
for i, dataset in enumerate(datasets):
    ...
    y_min = min(dataset_df[['Eda_Acc', 'Aeda_Acc', 'Num_Acc', 'Alpha_Acc', 'Hybrid_Acc']].min().min(), orig_acc) - 0.005
    y_max = max(dataset_df[['Eda_Acc', 'Aeda_Acc', 'Num_Acc', 'Alpha_Acc', 'Hybrid_Acc']].max().max(), orig_acc) + 0.005
