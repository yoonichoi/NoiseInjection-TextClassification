...
for i, dataset in enumerate(datasets):
    ...
    y_min = min(dataset_df[['Aeda_Acc', 'Num_Acc', 'Alpha_Acc']].min().min(), orig_acc) - 0.005
    y_max = max(dataset_df[['Aeda_Acc', 'Num_Acc', 'Alpha_Acc']].max().max(), orig_acc) + 0.005
    ...
    plt.savefig(f'{folder_path}/plots/without_hybrid/accuracy_trend_{dataset}_without_hybrid.png')
