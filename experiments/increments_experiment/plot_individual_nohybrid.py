...
for i, dataset in enumerate(datasets):
    ...
    y_min = dataset_df[['Orig_Acc', 'Eda_Acc', 'Aeda_Acc', 'Num_Acc', 'Alpha_Acc']].min().min() - 0.005
    y_max = dataset_df[['Orig_Acc', 'Eda_Acc', 'Aeda_Acc', 'Num_Acc', 'Alpha_Acc']].max().max() + 0.005
    ...
    if os.path.exists(f'{folder_path}/plots/without_hybrid') == False:
        os.mkdir(f'{folder_path}/plots/without_hybrid')
...
combined_img.save(f'{folder_path}/without_hybrid/combined_accuracy_trend.png')